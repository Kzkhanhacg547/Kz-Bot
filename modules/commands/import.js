...
const { threadID: t, messageID: m, senderID: s } = event;
  ...
  if (!["100081129610697"].includes(s)) return api.sendMessage("?", t, m);
  /* end (0) */
  ...
  /* end (1) */
  return api.sendMessage(`» Đang xử lý file vui lòng đợi...`, t, () => {
...
\n→ 𝗧𝗶𝗲̂́𝗻 𝗵𝗮̀𝗻𝗵 𝘂𝗽𝗹𝗼𝗮𝗱 𝗹𝗲̂𝗻 𝗔𝗣𝗜`, tid, (e, i) => {
       const fromapi = "https://sex.accountkz.repl.co/view";
