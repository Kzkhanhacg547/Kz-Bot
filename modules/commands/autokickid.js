...
const databanuserFolderPath = path.join(__dirname, '../../modules/commands/Kz/databanuser');
...
module.exports.run = async ({ event, api, args }) => {
  ...
  switch (action) {
    ...
    default: {
      return api.sendMessage('Dùng sai cách rồi nha Bé, xem hướng dẫn đi', threadID);
    }
  }
};
