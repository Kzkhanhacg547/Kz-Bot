...
"https://i.postimg.cc/L8J3smPM/tumblr-myzq44-Hv7-G1rat3p6o1-500.gif",
   ...
   var callback = () => api.sendMessage({body:`Vú của ${tag}` + ` căng quá.`,mentions: [{tag: tag,id: Object.keys(event.mentions)[0]}],attachment: fs.createReadStream(__dirname + "/cache/bopvu.gif")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/bopvu.gif"));  
