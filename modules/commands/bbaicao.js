...
var msg =  {body: `🃏====[ 𝐁𝐚̀𝐧 𝐁𝐚̀𝐢 𝐂𝐚̀𝐨 ]====🃏\n\n𝗖𝗵𝗮̀𝗼 𝗺𝘂̛̀𝗻𝗴 𝗯𝗮̣𝗻 𝘁𝗼̛́𝗶 𝘃𝗼̛́𝗶 𝘀𝗼̀𝗻𝗴 𝗯𝗮̣𝗰 𝗰𝘂̉𝗮 𝘁𝗵𝗮̂̀𝗻 𝗯𝗮̀𝗶 𝗗𝘂𝗯𝗮𝗶\n𝗡𝗲̂́𝘂 𝗺𝘂𝗼̂́𝗻 𝘁𝗵𝗮𝗺 𝗴𝗶𝗮 𝗯𝗮̣𝗻 𝗰𝗮̂̀𝗻 𝗻𝗵𝗮̣̂𝗽 𝗰𝗮́𝗰 𝗹𝗲̣̂𝗻𝗵 𝗻𝗵𝘂̛ 𝘀𝗮𝘂:\n» /𝗯𝗯𝗮𝗶𝗰𝗮𝗼 𝗰𝗿𝗲𝗮𝘁𝗲 [ Số Tiền Cược ]\n» /𝗯𝗯𝗮𝗶𝗰𝗮𝗼 𝘀𝘁𝗮𝗿𝘁 [ Bắt Đầu Bàn 3 Cây ]\n» /𝗯𝗯𝗮𝗶𝗰𝗮𝗼 𝗶𝗻𝗳𝗼 [ Xem Thông Tin Bàn Bài Cào ]\n» /𝗯𝗯𝗮𝗶𝗰𝗮𝗼 𝗷𝗼𝗶𝗻 [ Để Người Chơi Vào Game]\n» /𝗯𝗯𝗮𝗶𝗰𝗮𝗼 𝗹𝗲𝗮𝘃𝗲 [ Để Rời Bàn 3 Cây ]\n» 𝗖𝗵𝗶𝗮 𝗯𝗮̀𝗶 [ Để Chia Bài Cho Người Chơi Chỉ Có Chủ Bàn Mới Nhập Có Hiệu Lệnh ]\n» Đ𝗼̂̉𝗶 𝗕𝗮̀𝗶 [ Để Đổi Bài Mỗi Người Chơi Chỉ Có 2 Lượt Đổi Bài Tương Ứng ]\n» 𝗥𝗲𝗮𝗱𝘆 [ Sẵn Sàng Mở Bài ]\n» 𝗡𝗼𝗻𝗿𝗲𝗮𝗱𝘆 [ Xem Những Người Chưa Sẵn Sàng ]`, attachment : [
     ...
     switch (args[0]) {
      ...
      await Currencies.decreaseMoney(event.senderID, Number(args[1]));
        ...
        case "leave":
        case "-l": {
            if (typeof values.player == "undefined") return api.sendMessage("🃏 𝗛𝗶𝗲̣̂𝗻 𝘁𝗮̣𝗶 𝗰𝗵𝘂̛𝗮 𝗰𝗼́ 𝗯𝗮̀𝗻 𝗯𝗮̀𝗶 𝗰𝗮̀𝗼 𝗻𝗮̀𝗼, 𝗯𝗮̣𝗻 𝗰𝗼́ 𝘁𝗵𝗲̂̉ 𝘁𝗮̣𝗼 𝗯𝗮̆̀𝗻𝗴 𝗰𝗮́𝗰𝗵 𝘀𝘂̛̉ 𝗱𝘂̣𝗻𝗴 /𝗯𝗯𝗮𝗶𝗰𝗮𝗼 𝗰𝗿𝗲𝗮𝘁𝗲 [ 𝘀𝗼̂́ 𝘁𝗶𝗲̂̀𝗻 ]", threadID, messageID);
        ...
        case "-s": {
            ...
            if (values.player.length <= 1) return api.sendMessage("🃏 𝗛𝗶𝗲̣̂𝗻 𝘁𝗮̣𝗶 𝗯𝗮̀𝗻 𝗰𝗵𝗼̛𝗶 𝗰𝘂̉𝗮 𝗯𝗮̣𝗻 𝗸𝗵𝗼̂𝗻𝗴 𝗰𝗼́ 𝗻𝗴𝘂̛𝗼̛̀𝗶 𝗻𝗮̀𝗼 𝘁𝗵𝗮𝗺 𝗴𝗶𝗮, 𝗯𝗮̣𝗻 𝗰𝗼́ 𝘁𝗵𝗲̂̉ 𝗺𝗼̛̀𝗶 𝘁𝗵𝗲̂𝗺 𝗯𝗮̆̀𝗻𝗴 𝗰𝗮́𝗰𝗵 𝘆𝗲̂𝘂 𝗰𝗮̂̀𝘂 𝗻𝗴𝘂̛𝗼̛̀𝗶 𝗸𝗵𝗮́𝗰 𝗻𝗵𝗮̣̂𝗽 𝗹𝗲̣̂𝗻𝗵 /𝗯𝗯𝗮𝗶𝗰𝗮𝗼 𝗷𝗼𝗶𝗻", threadID, messageID);
