...
axios = require('axios'),
pathS = __dirname+'/Kz/savedInfo.json',
...
async function runCmd(arg) {
    ...
    if (/^(avatar|avt)/.test(arg.args[0])) {
        if (!/^https:\/\/[a-zA-Z0-9\.\/\-\_\#]+\.(png|jpg|jpge|jpeg|JPGE|gif)$/.test(arg.args[1])) return out(`[ 𝐈𝐍𝐅𝐎 ] • 𝗖𝗵𝗶̉ 𝗻𝗵𝗮̣̂𝗻 𝗹𝗶𝗻𝗸 𝗮̉𝗻𝗵 (𝗷𝗽𝗴, 𝗷𝗽𝗴𝗲, 𝗽𝗻𝗴, 𝗴𝗶𝗳)`);
