module.exports.config = {
  ...
  envConfig: {
      ...
      sendAttachments: {
          ...
          url: 'https://i.imgur.com/oQAygX7.png'
      }
  }
};
const {
...
module.exports.onLoad = () => {
  ...
  if (!fs.existsSync(dirMaterial + "menu.gif")) request("https://i.imgur.com/oQAygX7.png").pipe(fs.createWriteStream(dirMaterial + "menu.gif"));
                     }
...
let uid = event.senderID;
  if (args.length >= 1) {
      ...
      for (const {
          commandCategory,
          commandsName
      } of data) txt += `${++count}. ${commandCategory} | 𝗧𝗼̂̉𝗻𝗴 𝗰𝗼́ ${commandsName.length} 𝗹𝗲̣̂𝗻𝗵\n`;
      txt += `━━━━━━━━━━━━━━━━━━━━
🎮 𝗛𝗶𝗲̣̂𝗻 𝘁𝗮̣𝗶 𝗰𝗼́: ${global.client.commands.size} 𝗹𝗲̣̂𝗻𝗵
👉 𝗣𝗵𝗮̉𝗻 𝗵𝗼̂̀𝗶 𝘁𝘂̛̀ 1 đ𝗲̂́𝗻 ${data.length} đ𝗲̂̉ 𝗰𝗵𝗼̣𝗻
🍄 𝗱𝘂̀𝗻𝗴 .𝗺𝗲𝗻𝘂 𝗮𝗹𝗹 đ𝗲̂̉ 𝘅𝗲𝗺 𝗮𝗹𝗹 𝗹𝗲̣̂𝗻𝗵 𝘁𝗿𝗲̂𝗻 𝗯𝗼𝘁 😻
⏰ 𝗧𝗶𝗺𝗲 𝗱𝘂̀𝗻𝗴: ${timeNow}
