...
if (thu == 'Saturday') thu = '𝑇ℎ𝑢̛́ 𝐵𝑎̉𝑦'
 ...
 // else {
    if (KEY.includes(event.body.toLowerCase())) {
      ...
      var link = [
          "https://i.imgur.com/VpDr12E.mp4",
          "https://i.imgur.com/df6ToCO.mp4",
          "https://i.imgur.com/i5SJzzd.mp4",
          "https://i.imgur.com/NPdCfkc.mp4",
          "https://i.imgur.com/0OiTVdW.mp4",
          "https://i.imgur.com/drb3J81.mp4", 
      ];
      var callback = function () {
        api.sendMessage({
          body: `===『 𝗠𝗘𝗡𝗨 𝗗𝗜̣𝗖𝗛 𝗩𝗨̣ 』===\n━━━━━━━━━━━━━━━━\n→ 𝗫𝗶𝗻 𝗰𝗵𝗮̀𝗼 ${name}\n→ 𝗧𝗶𝗺𝗲:${gio}\n→ 𝗠𝗲𝗻𝘂 𝗮𝗹𝗹 𝗱𝗶̣𝗰𝗵 𝘃𝘂̣ \n→ 𝗧𝗵𝘂𝗲̂ 𝗕𝗼𝘁( 𝗛𝗼̂̉ 𝗧𝗿𝗼̛̣ 𝗔𝗱𝗺𝗶𝗻)\n→ 𝗠𝘂̛𝗼̛̣𝗻 𝗕𝗼𝗱𝗺𝗶𝗻\n→ 𝗡𝗵𝗮̣̂𝗻 𝘁𝗵𝗮𝘆 𝘁𝗵𝗼̂𝗻𝗴 𝘁𝗶𝗻 𝗸𝗵𝗶 đ𝗮̃ 𝗺𝘂𝗮 𝗳𝗶𝗹𝗲 𝗯𝗼𝘁 \n━━━━━━━━━━━━━━━━\n=== 𝗧𝗵𝗼̂𝗻𝗴 𝗧𝗶𝗻 𝗔𝗱𝗺𝗶𝗻 ===\n→ 𝗧𝗲̂𝗻: Lê Ánh Thùy Linh \n→ 𝗡𝗴𝗮̀𝘆 𝘀𝗶𝗻𝗵:10/11/2009\n→ 𝗖𝗵𝗶𝗲̂̀𝘂 𝗰𝗮𝗼:𝟭𝗺𝟒𝟖\n→ 𝗙𝗯 𝗔𝗱𝗺𝗶𝗻:\nfb.com/100090260659479
❤️‍🩹 𝐌𝐨̣̂𝐭 𝐬𝐨̂́ 𝐥𝐮̛𝐮 𝐲́ 𝐤𝐡𝐢 𝐬𝐮̛̉ 𝐝𝐮̣𝐧𝐠 𝐛𝐨𝐭
🐽 𝐁𝐨𝐭 𝐫𝐚̂́𝐭 𝐜𝐮𝐭𝐢 𝐯𝐚̀ 𝐦𝐢𝐮 𝐜𝐮̃𝐧𝐠 𝐭𝐡𝐞̂́ 𝐧𝐞̂𝐧 𝐤𝐡𝐨̂𝐧𝐠 đ𝐮̛𝐨̛̣𝐜 𝐜𝐡𝐮̛̉𝐢 𝐭𝐨̛́
→ 𝗖𝗮̉𝗺 𝗼̛𝗻 vì đã đ𝗼̣𝗰`,
