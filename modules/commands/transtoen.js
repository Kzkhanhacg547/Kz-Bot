...
module.exports.run = async function ({ api, event, args }) {
  ...
  const axios = require('axios');
	...
	return  request(encodeURI(`https://translate.googleapis.com/translate_a/single?client=gtx&sl=auto&tl=en&dt=t&q=${translateThis}`), async (err, response, body) => {
...
━━━━━━━━━━━━━━━━━━
🏤 𝗕𝗮̉𝗻 𝘀𝗮𝗼 𝗸𝗵𝗶 𝗱𝗶̣𝗰𝗵: ${text}`, attachment: (await global.nodemodule["axios"]({
